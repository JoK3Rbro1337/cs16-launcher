...
export const en = {
  ...
  commandPalette: {
    ...
    goToCfgBuilder: 'Go to CFG Builder',
  ...
  cfgBuilder: {
    title: 'CFG Builder',
    intro: 'Build a personal config from scratch, or load a preset and tweak it. Applies through a launcher-owned file — your own config.cfg is never touched.',

    sectionMouse: 'Mouse',
    sectionNetwork: 'Network',
    sectionVideo: 'Video',
    sectionAudio: 'Audio',
    sectionHud: 'HUD & Crosshair',
    sectionBinds: 'Binds',
    sectionPresets: 'Presets',
    sectionOutput: 'Apply & Export',

    sensitivityLabel: 'Sensitivity',
    sensitivityDesc: 'Mouse look sensitivity. Higher moves your view faster per inch of mouse movement.',
    zoom_sensitivity_ratioLabel: 'Zoom Sensitivity Ratio',
    zoom_sensitivity_ratioDesc: "Sensitivity multiplier while zoomed in (e.g. AWP scope), relative to your normal sensitivity.",
    m_filterLabel: 'Mouse Smoothing',
    m_filterDesc: 'Smooths mouse input across frames. Reduces jitter but adds a very small amount of input lag.',
    m_customaccelLabel: 'Mouse Acceleration',
    m_customaccelDesc: 'Movement speed affects how far the view turns, not just distance moved. Most competitive players leave this off.',

    rateLabel: 'Rate',
    rateDesc: 'Maximum bytes per second the client will accept from the server. Too low throttles the data the server can send you.',
    rateLowAdvisoryHint: 'Below what most modern servers expect — you may see choppier updates.',
    cl_updaterateLabel: 'Update Rate',
    cl_updaterateDesc: 'Requested snapshots per second from the server. Higher is smoother but needs more bandwidth.',
    cl_cmdrateLabel: 'Command Rate',
    cl_cmdrateDesc: 'Commands per second sent to the server. Should generally match or exceed the update rate.',
    ex_interpLabel: 'Interpolation',
    ex_interpDesc: "Interpolation time in seconds used to smooth other players' movement between updates.",
    cl_cmdbackupLabel: 'Command Backup',
    cl_cmdbackupDesc: 'How many old commands are resent each packet in case one is lost in transit.',
    cl_timeoutLabel: 'Timeout',
    cl_timeoutDesc: 'Seconds of no response from the server before the client gives up and disconnects.',
    cl_lcLabel: 'Lag Compensation',
    cl_lcDesc: 'The server rewinds other players to where you saw them when you fired.',
    cl_lwLabel: 'Lagged Weapons',
    cl_lwDesc: 'Predicts your own weapon effects locally instead of waiting for the server.',
    cl_predictLabel: 'Client Prediction',
    cl_predictDesc: 'Predicts your own movement locally so it feels instant instead of waiting on the network.',

    fps_maxLabel: 'Max FPS',
    fps_maxDesc: 'Caps your frame rate.',
    fps_maxHighAdvisoryHint: 'Legal, but unusually high for this engine — some servers behave inconsistently well above 100.',
    gl_vsyncLabel: 'V-Sync',
    gl_vsyncDesc: 'Synchronizes frames to your monitor refresh rate. Removes tearing but can add input lag.',
    gl_picmipLabel: 'Texture Detail',
    gl_picmipDesc: 'Reduces texture detail to improve performance. Higher values are blurrier but faster.',
    gammaLabel: 'Gamma',
    gammaDesc: 'Overall midtone brightness of the rendered image.',
    brightnessLabel: 'Brightness',
    brightnessDesc: 'Additional brightness boost on top of gamma.',
    cl_minmodelsLabel: 'Simplified Models',
    cl_minmodelsDesc: 'Uses a single simplified player model per team — easier to spot at a glance.',
    r_decalsLabel: 'Max Decals',
    r_decalsDesc: 'Maximum number of bullet holes and scorch marks kept on the map before old ones are cleared.',
    cl_weatherLabel: 'Weather Effects',
    cl_weatherDesc: 'Enables rain/snow particle effects on maps that have them.',

    volumeLabel: 'Master Volume',
    volumeDesc: 'Overall game sound volume.',
    hisoundLabel: 'High-Quality Sound',
    hisoundDesc: 'Uses higher-quality sound assets when available.',
    bgmvolumeLabel: 'Music Volume',
    bgmvolumeDesc: 'Volume of the background music track.',
    mp3volumeLabel: 'MP3 Volume',
    mp3volumeDesc: 'Volume of MP3 music playback.',
    suitvolumeLabel: 'Suit Volume',
    suitvolumeDesc: "Volume of the HEV suit's spoken voice cues (health/armor callouts).",

    hud_fastswitchLabel: 'Fast Weapon Switch',
    hud_fastswitchDesc: 'Switches weapons immediately on key press instead of opening a selection menu first.',
    hud_centeridLabel: 'Show Player Name',
    hud_centeridDesc: "Shows the name of the player you're looking at in the center of the screen.",
    cl_righthandLabel: 'Right-Handed View Model',
    cl_righthandDesc: 'Draws your weapon in your right hand instead of your left.',
    cl_radartypeLabel: 'Round Radar',
    cl_radartypeDesc: 'Uses the round radar style instead of the classic square one.',
    crosshairIntro: 'Crosshair is edited here using the same controls as Settings — one setting, either place.',

    bindsIntro: 'Pick a key for each action below, or leave it blank to skip it. Custom binds run through the same content scanner as everything else before anything is written to your game.',
    bindsMovementHeading: 'Movement',
    bindsActionHeading: 'Action',
    bindsBuyHeading: 'Buy',
    bindsCustomHeading: 'Custom Binds',
    bindsCustomDesc: 'For any bind not covered above — a raw key and command, exactly like a hand-written cfg.',
    bindsCustomAdd: 'Add Bind',
    bindsCustomKeyPlaceholder: 'key',
    bindsCustomCommandPlaceholder: 'command',
    bindsCustomRemoveAriaLabel: 'Remove custom bind',
    bindKeyPlaceholder: 'unbound',
    moveForwardLabel: 'Move Forward',
    ...
    duckLabel: 'Duck',
    walkLabel: 'Walk (slow)',
    useLabel: 'Use / Interact',
    attackLabel: 'Attack',
    attack2Label: 'Attack (secondary)',
    reloadLabel: 'Reload',
    buyMenuLabel: 'Open Buy Menu',
    autobuyLabel: 'Autobuy',
    rebuyLabel: 'Rebuy Last Purchase',
    buyAmmoPrimaryLabel: 'Buy Primary Ammo',
    buyAmmoSecondaryLabel: 'Buy Secondary Ammo',

    presetsIntro: 'Load any config from the Content archive as a starting point, then adjust individual fields above.',
    presetsNoManifest: 'No content manifest configured — set one in Settings to browse presets, or build entirely from scratch below.',
    presetsLoading: 'Loading…',
    presetsLoadButton: 'Load as Base',
    presetsLoadFailedToast: 'Could not load that preset',
    presetsBaseLabel: (label: string) => `Based on: ${label}`,
    presetsFieldsChanged: (n: number) => `${n} ${englishPlural(n, { one: 'field', other: 'fields' })} changed from base`,
    presetsNoBase: 'Starting from launcher defaults',
    presetsResetButton: 'Reset to Defaults',
    changedFromBaseTitle: 'Changed from base',

    outputIntro: 'Applying writes a small launcher-owned config and execs it alongside your own — nothing in cstrike/config.cfg is ever modified.',
    previewLabel: 'Preview',
    copyToClipboard: 'Copy to Clipboard',
    saveToFile: 'Save to File',
    applyButton: 'Apply to Game',
    applying: 'Applying…',
    applySuccessToast: 'Applied — will take effect next time you exec userconfig.cfg (usually your next launch).',
    applyBlockedTitle: 'Blocked — fix these before applying',
    applyBlockedMessage: (n: number) =>
      `${n} critical ${englishPlural(n, { one: 'finding', other: 'findings' })} in your custom binds — nothing was written to your game.`,
    removeFromGameButton: 'Remove From Game',
    removing: 'Removing…',
    removeSuccessToast: 'Removed from your game',
    lastAppliedLabel: (date: string) => `Last applied ${date}`,
